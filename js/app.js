...
(function () {
  ...
  /* ============================================================
     VERSIÓN ACTIVA
     Una sola hoja (css/tienda.css) con las dos versiones: la
     oscura en :root y la clara como tokens bajo
     [data-tema="clara"]. La función cambiarTema(), más abajo,
     sólo cambia ese atributo.
     ============================================================ */
  ...
  function stepConfirmar() {
    ...
    const body = stepsHTML(3) +
      '<div class="review"><p class="review__h">Tu pedido</p>' + rows +
        ...
        '<div class="review__row" style="font-size:1rem"><span>Total</span><span style="color:var(--accent)">' +
  ...
  /* Las dos versiones viven en css/tienda.css: la clara sólo reescribe
     tokens bajo [data-tema="clara"], así que alcanza con el atributo. */
